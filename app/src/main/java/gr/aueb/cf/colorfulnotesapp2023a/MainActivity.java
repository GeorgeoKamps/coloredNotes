package gr.aueb.cf.colorfulnotesapp2023a;
...
import gr.aueb.cf.colorfulnotesapp2023a.activities.LoginActivity;
import gr.aueb.cf.colorfulnotesapp2023a.adapters.NoteAdapter;
import gr.aueb.cf.colorfulnotesapp2023a.helpers.DBHelper;
import gr.aueb.cf.colorfulnotesapp2023a.helpers.DateStampHelper;
import gr.aueb.cf.colorfulnotesapp2023a.models.Note;
        ...
        DBHelper.getNotesReference().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    // sos! i will implement this code exact here!
